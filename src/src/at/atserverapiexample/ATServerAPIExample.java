...
public class ATServerAPIExample extends Thread
{
	...
	public void processInput(String userInput)
	{
		...
		else if(count == 4 && ((String)ls.get(0)).equalsIgnoreCase("getTicks2"))
		{
			...
			long request = apiSession.GetRequestor().SendATTickHistoryDbRequest(atSymbol, true, false, beginDateTime, endDateTime, ActiveTickServerAPI.DEFAULT_REQUEST_TIMEOUT);
